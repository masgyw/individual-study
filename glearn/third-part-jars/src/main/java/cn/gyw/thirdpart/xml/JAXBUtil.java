...
//    private final static Logger log= Logger.getLogger(JAXBUtil.class);
    /**
     * 将pojo转换为XML字符串
     * @param object
     * @return
    ...
    public static String convertToXml(Object object) {
        ...
        try {  
            ...
            System.out.println("DEBUG: XML字符串生成成功！");
    ...
    public static File convertToXmlFile(Object obj,String savePath) {
        ...
        if(xmlStr != null && !"".equals(xmlStr)) {
            ...
            try {
                ...
                writer.write(xmlStr);
                writer.flush();
                System.out.println("DEBUG: XML文件生成成功！");
//                log.debug("XML文件生成成功！");
            } catch (IOException e) {
                e.printStackTrace();
            } finally {
