...
<script>
  ...
  export default {
    ...
    methods: {
      query({page, limit}) {
        this.BASE_APIS.findByPage(apiTypes.PRODUCT_PIC, { page, limit })
          .then(resp => {
      ...
      add(params) {
        this.BASE_APIS.offer(apiTypes.PRODUCT_PIC, params)
          .then(resp => {
            this.query(this.pageInfo);
          })
      },
      deleteRow(data) {
        this.BASE_APIS.remove(apiTypes.PRODUCT_PIC,
          { "productPicId": data.productPicId })
          .then(resp => {
            this.query(this.pageInfo);
          })
      }
