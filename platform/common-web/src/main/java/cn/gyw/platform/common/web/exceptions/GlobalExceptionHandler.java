...
public class GlobalExceptionHandler {
    ...
    public BaseResponse handleBusinessException(BaseException e) {
        return BaseResponse.error(e.getRespCode().getCode(), getMessage(e));
    }
    ...
    public BaseResponse handleServletException(Exception e) {
        ...
        CommonRespEnum respEnum = CommonRespEnum.SERVER_ERROR;
        try {
            respEnum = CommonRespEnum.valueOf(e.getClass().getSimpleName());
        } catch (IllegalArgumentException ex) {
            LOGGER.error("Servlet exception :", ex);
        }
        return BaseResponse.error(respEnum);
    }
