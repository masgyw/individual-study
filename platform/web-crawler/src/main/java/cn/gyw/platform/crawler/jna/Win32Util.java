...
import static cn.gyw.platform.crawler.jna.User32Ext.USER32EXT;
import static cn.gyw.platform.crawler.jna.Win32MessageConstants.BM_CLICK;
import static cn.gyw.platform.crawler.jna.Win32MessageConstants.KEYEVENTF_KEYDOWN;
import static cn.gyw.platform.crawler.jna.Win32MessageConstants.KEYEVENTF_KEYUP;
import static cn.gyw.platform.crawler.jna.Win32MessageConstants.WM_SETTEXT;
import static cn.gyw.platform.crawler.jna.Win32MessageConstants.WM_CHAR;
...
public class Win32Util {
	 ...
	 * @param keyCombination 键盘的虚拟按键码（<a href=
	 *                       "http://msdn.microsoft.com/ZH-CN/library/windows/desktop/dd375731.aspx">Virtual-Key
	 *                       Code</a>），或者使用{@link java.awt.event.KeyEvent}</br>
