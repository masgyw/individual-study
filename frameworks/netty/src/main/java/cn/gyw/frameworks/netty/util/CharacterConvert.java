package cn.gyw.frameworks.netty.util;
...
public final class CharacterConvert {
	...
	/**
	 * hexString2String 16进制字符串转字符串 @param src 16进制字符串 @return 字节数组 @throws
	 */
	...
	/**
	 * char2Byte 字符转成字节数据char-->integer-->byte @param src @return @throws
	 */
	...
	/**
	 * intToHexString 10进制数字转成16进制 @param a 转化数据 @param len 占用字节数 @return @throws
	 */
	...
	/**
	 * byte转换成int型字符串 Convert byte[] to hex string
	 * 
	 * @param src byte[] data
	 * @return hex string
	 */
