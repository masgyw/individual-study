...
import cn.gyw.spring.web.ext.filter.UserFilter;
import cn.gyw.spring.web.ext.listener.UserListener;
...
public class MyServletContainerInitializer implements ServletContainerInitializer {
     ...
     * @throws ServletException 1）、使用ServletContext注册Web组件（Servlet、Filter、Listener）
