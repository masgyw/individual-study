package cn.gyw.middleware.zk.zookeeper.watcher;
...
public class ZooKeeperWatcher implements Watcher {
	...
	/** zookeeper服务器地址 */
	private static final String CONNECTION_ADDR = ZkConfig.INSTANCE.getZkServer();
	/** zk父路径设置 */
	 ...
	 * 删除所有节点
	 */
	public void deleteAllTestPath(boolean isNeedWatch) {
		if (this.exists(CHILDREN_PATH, isNeedWatch) != null) {
			this.deleteNode(CHILDREN_PATH);
		}
		if (this.exists(PARENT_PATH, isNeedWatch) != null) {
	...
	public static void main(String[] args) throws Exception {
		...
		if (zkWatch.createPath(PARENT_PATH, System.currentTimeMillis() + "")) {
			...
			// 读取数据
			System.out.println(">>read parent data");
			zkWatch.readData(PARENT_PATH, true);

			// 读取子节点
			System.out.println(">>read children path data");
