package cn.gyw.middleware.zk.curator.cluster;
...
public class Test {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Thread.sleep(3000);
        cf.create().creatingParentsIfNeeded().withMode(CreateMode.PERSISTENT).forPath("/super", "super".getBytes());
        System.out.println(cf.getChildren().forPath("/super").size());
