package cn.gyw.frame.thirdpart.javapoet;
...
public class JavaPoetTest {
    ...
    public static final String PKG_NAME = "cn.gyw.frame.thirdpart.javapoet";
    ...
    public void buildJavaFile() {
        ...
        JavaFile javaFile = JavaFile.builder(PKG_NAME, clazz).build();

        Path path = Paths.get("src/test/java");
        File srcDir = new File(path.toAbsolutePath().toString());
    ...
    public static MethodSpec method(CodeBlock codeBlock) {
        // Class<?>
        TypeName returnType = ParameterizedTypeName.get(ClassName.get(Class.class), TypeVariableName.get("?"));
