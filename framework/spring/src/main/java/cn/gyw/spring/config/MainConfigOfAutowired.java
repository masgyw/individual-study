...
import cn.gyw.spring.service.impl.HelloServiceImpl;
 ...
 *
 */
@ComponentScan(basePackages = {"cn.gyw.spring.controller", "cn.gyw.spring.service", "cn.gyw.spring.model"})
@Configuration
