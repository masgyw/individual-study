package cn.gyw.frameworks.flowable.holiday;
...
public class HolidayRequestController {
	...
	public String rollbaskTask(String taskId, String targetTaskKey) {
		...
		runtimeService.createChangeActivityStateBuilder().processInstanceId(currentTask.getProcessInstanceId())
			.cancelActivityId(targetTaskKey).changeState();
				// 高版本方法
//				.moveActivityIdsToSingleActivityId(key, targetTaskKey).changeState();
		return "驳回成功...";
	}
	...
	public List<HistoricProcessInstance> getMyStartProcint(String userId) {
		List<HistoricProcessInstance> list = historyService.createHistoricProcessInstanceQuery().startedBy(userId)
